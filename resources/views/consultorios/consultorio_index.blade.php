  ...
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <a href="/consultorioreg" class="btn btn-primary">NUEVO REGISTRO</a>
        <a href="{{ route('generarReporteConsultorios') }}" class="btn btn-success">Generar Reporte</a> 
          ...
          <table class="table" id="example1">
            ...
            <tbody>
                <?php $con=1; foreach ($consultorios as $value) { ?>
                    <tr>
                    <th><?php echo $con++; ?></th>
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">  
                          <li><a class="dropdown-item" href="#" onclick="editarConsultorio('<?php echo $value->id; ?>')">editar</a></li>
                          <li><a class="dropdown-item" href="#" onclick="eliminarconsultorio('<?php echo $value->id; ?>')">eliminar</a></li>
                        </ul>
                      </div>
                    </td>
                    </tr>
...
function editarConsultorio(id){
  ...
  $.post('/editarConsultorio', {id}, function(data) {
    $("#ver_form").html(data)
  });
}
...
function eliminarconsultorio(id){
  Swal.fire({
    ...
    if (result.isConfirmed) {
      $.post('/eliminarconsultorio', {id}, function() {
        window.location="";
      });
    }
  });
